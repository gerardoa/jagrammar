...
public class JaParser extends Parser {
        ...
        try {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    switch (alt5) {
                        case 1 :
                            ...
                            // AST REWRITE
                            // elements: modifier, methodDeclaration, type
                            // token labels: 
                            // rule labels: retval
                            // token list labels: 
                            // rule list labels: 
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: constructorBody, modifier, IDENTIFIER, formalParameters
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            switch (alt32) {
                ...
                case 3 :
                    ...
                    // AST REWRITE
                    // elements: FOR, expression, forUpdate, statement, forInit
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final JaParser.expression_return expression() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: expression, expression, orExpression, expression, orExpression, orExpression, orExpression, orExpression, expression, orExpression, orExpression, orExpression, orExpression, expression, orExpression
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
