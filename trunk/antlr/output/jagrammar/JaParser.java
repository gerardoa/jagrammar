...
public class JaParser extends Parser {
    ...
    public final JaParser.expression_return expression() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: EQ, orExpression, orExpression, expression, expression, expression, orExpression, expression, orExpression, orExpression, expression, orExpression, orExpression, orExpression, orExpression, orExpression
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
